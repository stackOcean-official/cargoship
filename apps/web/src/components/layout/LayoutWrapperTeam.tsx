...
export default function LayoutWrapperTeam({ children }) {
  ...
  const sidebarNavigation = useMemo(
    () => [
      {
        name: "Projects",
        href: `/app/teams/${router.query.teamId}/projects`,
        icon: WindowIcon,
                          ...
                          <a
                            ...
                            className={clsx(
                              item.current
                                ...
                                : "hover:bg-brand-dark text-sky-100 hover:text-white",
                              "group flex items-center rounded-md py-2 px-3 text-sm font-medium"
                            )}
                            aria-current={item.current ? "page" : undefined}>
                            <item.icon
                              className={clsx(
                                item.current ? "text-white" : "text-sky-300 group-hover:text-white",
                                "mr-3 h-6 w-6"
                              )}
                              aria-hidden="true"
                            />
